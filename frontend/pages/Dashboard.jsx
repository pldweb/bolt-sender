...
import { MessageSquare, Trash2, Edit2, Plus, Check, X, Send, Paperclip, LogOut } from 'lucide-react';
...
export default function Dashboard() {
    ...
    const updateSessionName = async (oldId) => {
        ...
        try {
            const encodedOldName = encodeURIComponent(oldId);
            const response = await axios.put(`${API_BASE}/session/${encodedOldName}/rename`, {
